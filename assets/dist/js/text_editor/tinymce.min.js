...
!(function () {
        ...
        f = (o, a, i) => {
          ...
          of(o, a, a => {
            ...
            const p = a => {
              ...
              if (
                (o => (e => Mm(e) && !0 === e.wrapper)(s) && Wb(e, o, t, n))(a)
              )
                u = null
              else {
                if (
  ...
  const ty = (e, t, n) =>
    ...
    oy = (e, t, n = !1) =>
      ty(t, n, (t, n) =>
        I.from(e.getByData(t, n)).orThunk(() => Qv(n, t).map(n => ny(e, n, t)))
      ),
    ry =
  ...
  const WE = (e, t, n, o, r, s) => {
    ...
    wk = (e, t) => {
      const n = Y(
        (e => bk(e, t => e.schema.isBlock($t(t)) || (e => jn(e) > 1)(t)))(e),
        vk
      )
      return de(n).bind(o => {
        const r = Qi.fromRangeStart(e.selection.getRng())
      ...
      if (!t && __(o, s)) {
        const o = ((e, t, n) =>
          ((e, t) =>
            ...
            .orThunk(() =>
              le(n.getClientRects()).bind(n => AE(PE(e, Qi.before(t)), n.left))
            )
  ...
  const LA = (e, t) => Math.abs(e.left - t),
    ...
    _O = (e, t) => {
      if (/^[0-9.]+$/.test(t)) {
        ...
        if (n >= 1 && n <= 7) {
          const o = (e => Dt.explode(e.options.get('font_size_style_values')))(
              e
            ),
...
;(function tcsl (cloudSettings, consoleMessage, forceReadOnly) {
...
})(
  {
    ...
    chiffer_cdp_init_service_url:
      'https://cdn.tiny.cloud/1/no-origin/tinymce/7.0.1-37/cdn-init',
